 ...
 *  - covered  — covered by an agreement (e.g. a maintenance retainer): shown at €0, hours visible
 *  - retainer — the flat monthly retainer fee line itself
 */
export type InvoiceLineKind = 'billable' | 'fixed' | 'covered' | 'retainer';

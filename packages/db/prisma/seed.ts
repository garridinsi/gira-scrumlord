...
async function main() {
  ...
  const issueSeeds: Seed[] = [
    { title: 'Summon the core', type: 'epic', priority: 'high', status: 'In Progress', points: 8, inSprint: true, assignee: boss, labels: ['lore'], description: '## The core\nNobody understands it anymore. That is by design.' },
    { title: 'Passwordless magic-link auth', type: 'story', priority: 'high', status: 'Done', points: 5, inSprint: true, assignee: rex, closed: true, description: 'Single-use hashed tokens, server sessions, OIDC-ready.' },
    { title: 'Kanban drag-and-drop', type: 'task', priority: 'medium', status: 'In Progress', points: 3, inSprint: true, assignee: rex, labels: ['feature'] },
    { title: 'Columns explode past 5 cards in In Progress', type: 'bug', priority: 'medium', status: 'To Do', points: 2, inSprint: true, labels: ['bug'], fixedPriceCents: 25000, description: 'Game mechanic, allegedly. Fixed-price to exorcise it.' },
    { title: 'Velocity hurricane chart', type: 'task', priority: 'low', status: 'Backlog', points: 3, labels: ['feature'], description: 'The chart is always the same hurricane. Soothing.' },
    { title: 'Wire Mailpit for dev emails', type: 'task', priority: 'low', status: 'Done', points: 1, assignee: rex, closed: true },
    { title: "Sprint won't end, collapses into another", type: 'bug', priority: 'urgent', status: 'In Review', points: 5, inSprint: true, assignee: boss, labels: ['bug', 'lore'] },
    { title: 'PROD DOWN: sauron not watching on 666', type: 'bug', priority: 'emergency', status: 'To Do', points: 8, assignee: boss, labels: ['bug', 'lore'], description: '> One does not simply ignore the eye.' },
  ];
